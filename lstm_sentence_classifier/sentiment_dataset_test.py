    ...
    def splits(cls, text_field, label_field, id_field, split_folder, shuffle=True ,root='.', **kwargs):
        ...
        Arguments:
            ...
            Remaining keyword arguments: Passed to the splits method of
                Dataset.
        """
        path = "../../datasets/EmotionDataset/lstm_data/" + split_folder + "/"
        print "Split:  "  + path
...
# load ED dataset
def load_ed(text_field, label_field, id_field, batch_size = 1, split_folder='test'):
    print('loading data')
    train_data, test_data = ED.splits(text_field, label_field, id_field, split_folder)
