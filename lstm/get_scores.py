...
target = 'test_all'
out_file_name = 'MMHS50K_niggaFaggot_lstm_scores'
split_name = 'tweets.' + target
out_file = open("../../../datasets/HateSPic/MMHS50K/lstm_scores/" + out_file_name + ".txt",'w')
split_folder = ''
model_name = 'MMHS50K_niggaFaggot_hidden_150_embedding_100_best_model_acc_val57' # 'saved_hate_annotated_hidden_50_best_model_minibatch_acc_77'
